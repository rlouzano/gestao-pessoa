...
public interface SalvarPessoaGestaoSistemaUseCasePort {

    PessoaGestaoSistemaDTO createPessoaGestaoSistemaRequest(PessoaGestaoSistemaRequest pessoaGestaoSistemaRequest);
}
